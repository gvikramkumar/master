...
const a = [
  'DRSHIPMENT-ROLL3-SL3',
  'DRSHPREVSW-ROLL3-SL1',
  '2TSUBDIR-MTD-SL1E1-SCMSE1',
  'DRSHPREVSW-ROLL3-SL3PF',
  'GLREVMIX-MTD-PF-SL1E1-SCMSE2',
  'GLREVMIX-MTD-BU-SL1E1-SCMSE2',
  'GLREVMIX-ROLL3-SL2PF-SL1E1',
  'GLREVMIX-MTD-SL3',
  'GLREVMIX-ROLL3-SL2-SL1E1-SCMSE2',
  'GLREV-PRIOR3-SL3',
  'GLREV-ROLL3-SL2-SL1E1-SCMSE2',
  'PDF-MTD-SL2PF-SL1E1',
  'LEGACYDRVR-MTD-SL6PF-SL1E1-SCMSE1',
  'REMKTREV-ROLL3-SL1E1-SCMSE1',
  'GLREVMIX-MTD-SL1PF-SL1E1-SCMSE2',
  'MSCP-MTD-SL2-SL1E1',
  'REVPOS-ROLL3-SL3PF',
  'AMERICASMISC-MTD-SL1E1-SL2E1-SCMSE1',
  'REVPOS-ROLL3-SL3PF',
  'REVPOS-MTD-SL1E1-SCMSE1',
  'EMERGINGMKTSMISC-MTD-SL1E1-SCMSE1',
  'REVPOS-ROLL3-SL2PF-SL1E1',
  'REVPOSDIS-ROLL3',
  'REVPOS-ROLL3-SL1PF-SL1E1-SCMSE1',
  'CORPADJ-MTD-SL1E1-SCMSE1',
  'REVPOS-ROLL3-SL1',
  'REVPOS-ROLL3-SL2PF-SL1E2-TGE1-SCMSE3',
  'REVPOS-MTD-SL1-SL1E1-SCMSE1',
  'REVPOS-ROLL3-SL1E1-SCMSE2',
  'REVPOS-MTD-SL1-SL1E1-SCMSE1',
  'REVPOS-ROLL3-PF-SL1E1-SCMSE1',
  'REVPOS-MTD-SL2-SL1E1-SCMSE1',
  'REVPOS-ROLL3-SL1',
  'REVPOS-MTD-SL1-SL1E1-SCMSE1',
  'SHREVPOS-MTD-SL3PFCNTEXT-SL1E1-SCMSE1',
  'REVPOS-MTD-SL2-SL1E1-SCMSE1',
  'REVPOS-ROLL3-SL2BE-SL1E1-SCMSE2',
  'REVPOS-ROLL3-SL2-SL1E2-SCMSE3',
  'USCANMISC-MTD-SL1E1-SL2E2-SCMSE2',
  'REVPOS-ROLL3-SL2-SL1E1-SCMSE2',
  'SHREVPOS-MTD-SL3EXT-SL1E1-SCMSE2',
  'SERVMAP-MTD-PFLE',
  'SHIPMENT-MTD-LE-SL1E3',
  'SHIPMENT-ROLL3-LE-SL1E3-SCMSE1',
  'SERVTRNMAP-MTD-PF',
  'SHIPMENT-ROLL3-SL2BE-SL1E1',
  'SHIPMENT-ROLL3-SL1E3-SCMSE1',
  'SHIPMENT-MTD-SL1E1-SCMSE2',
  'SHIPMENT-ROLL3-SL1E4-SCMSE1',
  'SHIPMENT-MTD-BU-SL1E1-SCMSE2',
  'SHIPMENT-ROLL3-SL1BU-SL1E2-SCMSE1',
  'SHIPMENT-ROLL3-BU-SL1E1-SCMSE2',
  'SHIPMENT-ROLL3-SL2BU-SL1E2-TGE1-SCMSE3',
  'SHIPMENT-MTD-SL3BU',
  'SHIPMENT-ROLL3-SL3BU-SL1E1-SCMSE1',
  'SHIPMENT-MTD-SL3BU-SL1E1',
  'SHIPMENT-MTD-PF-SL1E3-SCMSE1',
  'SHIPMENT-MTD-PF-SL1E1-SCMSE2',
  'SHIPMENT-ROLL3-PF-SL1E1',
  'SHIPMENT-MTD-SL1PF-SL1E1',
  'SHIPMENT-MTD-PF-SL1E1-SCMSE2',
  'SHIPMENT-MTD-SL1PF-SL1E1-SCMSE2',
  'SHIPMENT-ROLL3-SL1PF-SL1E1-SCMSE1',
  'SHIPMENT-ROLL3-SL2PF-SL1E3',
  'SHIPMENT-MTD-SL2PF-SL1E1-SCMSE2',
  'SHIPMENT-MTD-SL2PF',
  'SHIPMENT-ROLL3-SL2PF-SL1E1-SCMSE2',
  'SHIPMENT-ROLL3-SL2PF-SL1E2-TGE1-SCMSE3',
  'SHIPMENT-ROLL3-SL2PFSCMSLE-SL1E1',
  'SHIPMENT-ROLL3-SL2PF-SL1E1-SCMSE1',
  'SHIPMENT-MTD-SL3PF',
  'SHIPMENT-ROLL3-SL3PF-SL1E1-SCMSE1',
  'SHIPMENT-MTD-SL2PF-SL1E1-SCMSE2',
  'SHIPMENT-ROLL3-SL3PF-SL1E1-SCMSE1',
  'SHIPMENT-ROLL3-SL3PF',
  'SHIPMENT-MTD-SL6PF',
  'SHIPMENT-MTD-SL6PF-SL1E1',
  'SHIPMENT-ROLL3-SL6PF-SL1E1',
  'SHIPMENT-ROLL3-SL6PF-SL1E1-SCMSE1',
  'SHIPREV-MTD-BU-SL1E5-TGE2-SCMSE1',
  'SHIPREV-MTD-SL1E1-SCMSE2',
  'SHIPREV-MTD-SL1E5-TGE2-SCMSE1',
  'SHIPREV-MTD-PF-SL1E5-TGE2-SCMSE1',
  'SHIPREV-MTD-BE-SL1E1-SCMSE1',
  'SHIPREV-ROLL3-SL1E1-SCMSE2',
  'SHIPREV-ROLL3-SL1E1-PFE1-SCMSE1',
  'SHIPREV-ROLL3-BU-SL1E1-SCMSE2',
  'SHIPREV-ROLL3-SL1E1-BUE1-SCMSE1',
  'SHIPREV-MTD-PF-SL1E1-SCMSE2',
  'SHIPREV-MTD-BU-SL1E1-SCMSE2',
  'SHIPREV-ROLL3-PFEXT-SL1E1-SCMSE1',
  'SHIPREV-ROLL3-SL1PF-SL1E1-SCMSE2',
  'SHIPREV-MTD-SL1PF-SL1E1-SCMSE1',
  'SHIPREV-MTD-SL2PF-SL1E1-SCMSE2',
  'SHIPREV-MTD-SL2PFSCMS-SL1E1-SCMSE2',
  'SHIPREV-ROLL3-SL2PF-SL1E1-SCMSE2',
  'SHIPREV-MTD-SL2PF-SL1E1-SCMSE1',
  'SHIPREV-ROLL3-SL3PF-SL1E1-SCMSE2',
  'SHIPREV-ROLL3-SL6PF-SL1E1-SCMSE2',
  'SHIPREV-ROLL6-SL3PF-SL1E1-SCMSE1',
  'SHIPREV-MTD-SL6PFSCMS-SL1E1-SCMSE2',
  'SHIPREV-ROLL3-SL4PF-SL1E1-SCMSE2',
  'SHIPREV-ROLL3-SL2-SL1E1-SCMSE2',
  'SHIPREV-PRIOR3-SL1-SL1E1',
  'SHIPREV-MTD-SL1TGSCMSLE-SL1E6-SL2E3-SL3E1-TGE3-BUE2-PFE2-SCMSE4-BEE1',
  'SHIPREV-ROLL3-SL2PF-SL1E2-TGE1-SCMSE2',
  'SHIPREV-ROLL3-SL6SCMS',
  'SHIPMENT-ROLL3-SL1-SL1E1-SCMSE2',
  'SHIPMENT-ROLL3-SL1',
  'SHIPMENT-ROLL3-SL1-SL1E1-SCMSE1',
  'SHIPMENT-MTD-SL2-SL1E1-SCMSE2',
  'SHIPMENT-MTD-SL2-SL1E1-SCMSE2',
  'SHIPMENT-ROLL3-SL2-SL1E1-SCMSE1',
  'SHIPMENT-ROLL3-SL2-SL1E1-SCMSE2',
  'SHIPMENT-ROLL6-SL2-SL1E1-SCMSE1',
  'SHIPMENT-ROLL3-SL2-SL1E1-SCMSE1',
  'SHIPMENT-ROLL3-SL3-SL1E1-SCMSE1',
  'SHIPMENT-ROLL3-SL3-SL1E1-SCMSE1',
  'SHIPMENT-ROLL3-SL3',
  'SHIPMENT-ROLL3-SL6PF-SL1E1-SCMSE2',
  'SHIPMENT-ROLL3-SL4-SL1E1',
  'SHIPMENT-ROLL6-SL3-SL1E1-SCMSE1',
  'SVCREVT3-ROLL3-SL1-SL1E1',
  'VIP-MTD-SL6PF-SL1E1',
  'SERVSLSMAP-MTD-ACCTSUBACCTCOMP',
  'VIP-MTD-SL2-SL1E1-SCMSE1',
  'VIP-MTD-SL2PF-SL1E1-SCMSE1',
  'DEFAULT-MTD-SL6PF-SL1E1-SCMSE1',
];

console.log(a.length);
console.log(_.uniq(a).length);
