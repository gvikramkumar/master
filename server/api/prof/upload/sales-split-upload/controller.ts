...
export default class SalesSplitUploadUploadController extends UploadController {
  ...
  getValidationAndImportData() {
    return Promise.all([
      ...
      this.pgRepo.getSortedUpperListFromColumn('vw_fds_financial_department', 'company_code'),
      this.pgRepo.getSortedUpperListFromColumn('vw_fds_sales_hierarchy', 'sales_territory_name_code')
    ])
      .then(results => {
